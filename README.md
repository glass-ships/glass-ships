...
| [biolink/biolink-model](https://github.com/biolink/biolink-model) | [v4.1.4](https://github.com/biolink/biolink-model/releases/tag/v4.1.4) | Schema and generated objects for biolink data model and upper ontology | 
