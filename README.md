...
|---|:-:|---| 
| [biolink/biolink-model](https://github.com/biolink/biolink-model) | [v4.1.5](https://github.com/biolink/biolink-model/releases/tag/v4.1.5) | Schema and generated objects for biolink data model and upper ontology | 
